...
package org.EMPCTF.game.impl;

import org.EMPCTF.cmd.impl.FollowCommand;
import org.EMPCTF.cmd.impl.SayCommand;
import org.EMPCTF.cmd.impl.UnbanIPCommand;
import org.EMPCTF.cmd.impl.AfkCommand;
//import org.EMPCTF.cmd.impl.HugCommand;
import org.EMPCTF.cmd.impl.TutorialCommand;
import org.EMPCTF.cmd.impl.StoreCommand;
//import org.EMPCTF.cmd.impl.RapeCommand;
import org.EMPCTF.cmd.impl.HideCommand;
import org.EMPCTF.cmd.impl.TntCommand;
import org.EMPCTF.cmd.impl.DeOperatorCommand;
import org.EMPCTF.cmd.impl.StatsCommand;
import org.EMPCTF.cmd.impl.UnbanCommand;
import org.EMPCTF.cmd.impl.TeleportCommand;
import org.EMPCTF.cmd.impl.DefuseCommand;
import org.EMPCTF.cmd.impl.SolidCommand;
import org.EMPCTF.cmd.impl.DefuseTNTCommand;
import org.EMPCTF.cmd.impl.MapListCommand;
import org.EMPCTF.cmd.impl.DropCommand;
import org.EMPCTF.cmd.impl.RagequitCommand;
import org.EMPCTF.cmd.impl.LavaCommand;
import org.EMPCTF.cmd.impl.EndCommand;
import org.EMPCTF.cmd.impl.ModifyCommand;
import org.EMPCTF.cmd.impl.ShieldCommand;
import org.EMPCTF.cmd.impl.PmCommand;
import org.EMPCTF.cmd.impl.BanIPCommand;
//import org.EMPCTF.cmd.impl.TickleCommand;
import org.EMPCTF.cmd.impl.ForceCommand;
import org.EMPCTF.cmd.impl.MeCommand;
import org.EMPCTF.cmd.impl.MuteCommand;
//import org.EMPCTF.cmd.impl.WhoCommand;
import org.EMPCTF.cmd.impl.JoinCommand;
import org.EMPCTF.cmd.impl.HiddenCommand;
import org.EMPCTF.cmd.impl.UnmuteCommand;
import org.EMPCTF.cmd.impl.PointsCommand;
import org.EMPCTF.cmd.impl.VoteCommand;
import org.EMPCTF.cmd.impl.PInfoCommand;
import org.EMPCTF.cmd.impl.WaterCommand;
import org.EMPCTF.cmd.impl.BanCommand;
import org.EMPCTF.cmd.impl.OpChatCommand;
import org.EMPCTF.cmd.impl.OperatorCommand;
import org.EMPCTF.cmd.impl.StatusCommand;
//import org.EMPCTF.cmd.impl.KissCommand;
import org.EMPCTF.cmd.impl.RedCommand;
import org.EMPCTF.cmd.impl.BanXCommand;
import org.EMPCTF.cmd.impl.CuboidCommand;
import org.EMPCTF.cmd.impl.InfoCommand;
import org.EMPCTF.cmd.impl.NewGameCommand;
import org.EMPCTF.cmd.impl.KickCommand;
import org.EMPCTF.cmd.impl.TeamCommand;
import org.EMPCTF.cmd.impl.BlueCommand;
import org.EMPCTF.cmd.impl.RulesCommand;
...
import org.EMPCTF.Configuration;
import org.EMPCTF.Constants;
import org.EMPCTF.Server;
import org.EMPCTF.game.GameModeAdapter;
...
import org.EMPCTF.model.MineActivator;
import org.EMPCTF.model.Player;
import org.EMPCTF.model.PlayerUntagger;
import org.EMPCTF.model.Position;
import org.EMPCTF.model.Teleporter;
...
//All the join messages
    ...
    public void playerConnected(Player player) {
            ...
            World.getWorld().broadcast(player.getColoredName()+" &ejoined the Empyre");
        }
            else {
            player.setAttribute("hasVisited", "true");
            World.getWorld().broadcast("&eWelcome "+player.getColoredName()+" &eto the server!");
        }
            player.getActionSender().sendChatMessage("&eWelcome to &c24/7 Empyre Gaming Capture the Flag");
            ...
            player.getActionSender().sendChatMessage("&eVisit our website at &cEmpyregaming.com");
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                try {
                    ...
                    World.getWorld().broadcast("&eTop Players:");
                    if(top[0] == null) {
	...
	public void playerDisconnected(Player p)
        {
            ...
            World.getWorld().broadcast(p.getColoredName()+" &eleft the Empyre");
        }
